      ...
      {showAbout && (
        <div className="about-popup">
          <div className="about-content">
            ...
            <h2>
              About <span className="anv">NOVARA</span>
            </h2>
            <p>
              Hey ! It's{" "}
              <a
                href="https://muazzammukadam.vercel.app"
                target="_blank"
              ...
              match. With a sleek, minimalist UI, Novara makes music selection
              fast, aesthetic, and vibe-driven. No sign-up walls, no fluff ,
              just pure mood-matching tunes in one click. Songs redirect
              seamlessly to Spotify, so you can dive straight into the vibe.{" "}
            </p>
          </div>
        </div>
      )}
